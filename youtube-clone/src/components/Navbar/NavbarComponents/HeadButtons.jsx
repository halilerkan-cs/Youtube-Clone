  ...
  return (
    <div className="head-buttons-wrapper">
      <div
        ...
        <svg viewBox="0 0 20 20" width={'27px'} height={'27px'} style={{ display: 'flex' }}>
          <path
      ...
      <div
        ...
        <svg
          viewBox="-0.5 -9.5 10 10"
          width={'27px'}
          height={'27px'}
          style={{ fill: 'white', height: '30', width: '20' }}>
          <text style={{ fill: 'white', x: '0', y: '10' }}>H</text>
        </svg>
      </div>
    </div>
  );
